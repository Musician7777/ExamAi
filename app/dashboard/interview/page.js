...
export default function InterviewPage() {
  ...
  const [lastFeedback, setLastFeedback] = useState(null); // eslint-disable-line no-unused-vars
  const [lastScore, setLastScore] = useState(null); // eslint-disable-line no-unused-vars
  ...
  useEffect(() => {
    if (
      ...
      const t = setTimeout(() => {
        // Fallback: speech ended, starting mic
        startListening();
      }, 800);
  ...
  /* ─── Score: divide by TOTAL expected questions ─── */
            ...
            <div className={styles.builderGrid}>
              ...
              <div className={styles.fieldGroup}>
                ...
                <select
                  ...
                  onChange={(e) => setCustomConfig((p) => ({ ...p, tone: e.target.value }))}
                >
        ...
        <div className={styles.analysisSection}>
          ...
          {reviewData.map((item, i) => (
            <div key={i} className={styles.summaryQItem}>
              <div
                className={styles.summaryQHeader}
        ...
        <div className={styles.transcriptMode}>
          ...
          <div className={styles.chatInputArea}>
            ...
            <div className={styles.inputActions}>
              ...
              <button className={styles.sendBtn} onClick={manualSend} disabled={isThinking || !input.trim()}>
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
