    ...
    return (
        <div className="min-h-screen flex relative overflow-hidden">
            ...
            <div className="hidden lg:flex flex-col justify-center flex-1 px-16 relative z-10">
                <h1 className="text-4xl font-bold mb-4">Welcome back to<br /><span className="gradient-text">ExamAI</span></h1>
                <p className="text-muted-foreground mb-10 max-w-md">Continue your preparation journey. Your AI-powered exam partner is ready.</p>
            ...
            <div className="flex-1 flex items-center justify-center p-8 relative z-10">
                <Card className="w-full max-w-md">
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <Button variant="outline" className="w-full gap-2" onClick={() => signIn('google', { callbackUrl })} type="button">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="password" type="password" placeholder="••••••••" value={form.password} onChange={(e) => setForm({ ...form, password: e.target.value })} required disabled={loading} />
                            </div>
