                            ...
                            {emailSent ? (
                                <>
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        We&apos;ve sent a password reset link to <strong>{email}</strong>. Click the link in the email to set a new password. The link expires in 1 hour.
                                    </p>
                                    <div className="p-3 rounded-lg bg-secondary/50 border text-xs text-muted-foreground">
                                        ...
                                        <button
                                            ...
                                            onClick={() => { setMessage(null); setEmailSent(false); setResetUrl(null); }}
                                        >
                                            try again
                                        </button>
                                ...
                                <>
                                    ...
                                    {resetUrl && (
                                        <div className="p-3 rounded-lg bg-secondary/50 border text-xs font-mono break-all">
                                            {resetUrl}
                                        </div>
                                    )}
                                    {resetUrl && (
