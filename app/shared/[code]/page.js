...
function SharedResultContent() {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-background p-4">
                <Card className="max-w-md w-full p-8 text-center space-y-4">
                    ...
                    <p className="text-muted-foreground">{error || 'This shared result may have been removed or the link is invalid.'}</p>
                    <Link href="/">
                        <Button variant="brand" className="gap-2"><Zap className="h-4 w-4" /> Go to ExamAI</Button>
                    </Link>
                </Card>
            </div>
        );
    ...
    if (resultType === 'exam') {
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-background via-background to-secondary/20 p-4 md:p-8">
                <div className="max-w-3xl mx-auto space-y-6">
                    <div className="text-center">
                        <h1 className="text-3xl font-bold">📊 Shared <span className="gradient-text">Exam Results</span></h1>
                        ...
                        <div className="flex items-center justify-center gap-3 text-xs text-muted-foreground mt-2">
                            <span className="flex items-center gap-1"><Eye className="h-3 w-3" /> {viewCount} views</span>
                            <span>•</span>
                    ...
                    {sectionResults?.length > 0 && (
                        <Card className="p-6 space-y-3">
                            <h3 className="font-semibold flex items-center gap-2"><BarChart3 className="h-4 w-4 text-primary" /> Section Breakdown</h3>
                    ...
                    <div className="text-center">
                        <Link href="/">
                            <Button variant="brand" className="gap-2"><Zap className="h-4 w-4" /> Try ExamAI</Button>
                        </Link>
                    </div>
                </div>
            </div>
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-background via-background to-secondary/20 p-4 md:p-8">
            <div className="max-w-3xl mx-auto space-y-6">
                <div className="text-center">
                    <h1 className="text-3xl font-bold">📊 Shared <span className="gradient-text">Results</span></h1>
                    <p className="text-muted-foreground mt-1">{title}</p>
                </div>
                <Card className="p-8 text-center">
