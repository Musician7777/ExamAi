...
2. **API Logic & AI Prompting (`app/api/gemini/route.js`)**:
   ...
   - *Example prompt injection*: "You are an expert exam paper setter for UPSC... Generate a realistic, high-quality exam paper with EXACTLY 20 questions... Return a JSON object with this EXACT structure..."
