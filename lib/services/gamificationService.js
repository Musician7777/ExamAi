...
const BADGES = {
    ...
    first_interview: { id: 'first_interview', name: 'First Interview', emoji: '🎤', description: 'Complete your first interview' },
    ...
    speed_demon: { id: 'speed_demon', name: 'Speed Demon', emoji: '⚡', description: 'Complete exam in under half the time limit' },
...
export async function awardXP(userId, activityType, details = {}) {
    ...
    let xpAwarded = 0;
    const newBadges = [];
    const percentage = details.totalMarks > 0
        ? Math.round((details.score / details.totalMarks) * 100)
        : 0;
