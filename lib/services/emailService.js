...
// We initialize Resend lazily inside the functions to ensure process.env is fully loaded
...
export async function sendPasswordResetEmail({ to, token }) {
  ...
  try {
    ...
    if (error) {
      ...
      return { sent: false, resetUrl: null, error: error.message || 'Unknown Resend error' };
    }
