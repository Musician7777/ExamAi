...
export const shareResultSchema = z.object({
  ...
  data: z.record(z.unknown(), { required_error: 'Data is required' }),
});
...
export const sharePresetSchema = z.object({
  ...
  config: z.record(z.unknown(), { required_error: 'Config is required' }),
  title: z.string().trim().min(1, 'Title is required').max(200),
...
export const examSessionCreateSchema = z.object({
  examData: z.record(z.unknown(), { required_error: 'Exam data is required' }),
