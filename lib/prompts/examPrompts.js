...
export const examProfiles = {
    'upsc': {
        ...
        duration: 120, marksPerQuestion: 2, negativeMarking: 0.66,
    },
    'ssc': {
        ...
        duration: 60, marksPerQuestion: 2, negativeMarking: 0.50,
    },
    'banking': {
        ...
        topics: 'Data Interpretation, Number Series, Simplification, Approximation, Percentage, Ratio, Profit & Loss, SI/CI, Inequality, Syllogism, Puzzles & Seating Arrangement, Coding-Decoding, Blood Relations, Reading Comprehension, Para Jumbles, Banking Terms, RBI Policies, Computer Basics',
        style: 'Data-heavy analytical questions with complex puzzles.',
        duration: 60, marksPerQuestion: 1, negativeMarking: 0.25,
    },
    'railways': {
        ...
        topics: 'Number System, Decimals, Fractions, LCM/HCF, Ratio, Percentage, Mensuration, Time & Work, Analogies, Coding-Decoding, Syllogism, Indian History, Geography, Polity, Physics, Chemistry, Biology',
        style: 'Straightforward questions testing fundamental knowledge.',
        duration: 90, marksPerQuestion: 1, negativeMarking: 0.33,
    },
    'state-psc': {
        ...
        topics: 'State-specific history and geography, Indian Constitution, Governance, Social Justice, International Relations, Indian Economy, Environment, Ecology, Science & Technology',
        style: 'Similar to UPSC but with more focus on state-specific knowledge.',
        duration: 120, marksPerQuestion: 2, negativeMarking: 0.33,
    },
    'software': {
        ...
        topics: 'Arrays, Linked Lists, Trees, Graphs, Hash Tables, Sorting, Searching, Dynamic Programming, OOP Principles, Design Patterns, SQL Queries, Normalization, ACID, Process Management, TCP/IP, HTTP, REST APIs, Caching, Load Balancing, Microservices',
        style: 'Technical questions testing deep CS fundamentals.',
        duration: 60, marksPerQuestion: 4, negativeMarking: 0,
    },
    'product': {
        ...
        topics: 'Advanced Graph Algorithms, Advanced DP, Segment Trees, Tries, Union-Find, Distributed Systems, Database Sharding, Message Queues, LRU Cache Design, OS Internals, Network Protocols, Probability, Combinatorics',
        style: 'Highly challenging questions that test problem-solving ability and deep CS knowledge.',
        duration: 90, marksPerQuestion: 4, negativeMarking: 0,
    },
    'startup': {
        ...
        topics: 'React/Next.js, Node.js, REST/GraphQL APIs, MongoDB/PostgreSQL, Authentication, HTML/CSS/JavaScript, TypeScript, Git, CI/CD, Docker, AWS/GCP',
        style: 'Practical, real-world questions focused on building things.',
        duration: 45, marksPerQuestion: 2, negativeMarking: 0,
    },
    'campus': {
        ...
        topics: 'Number System, Probability, P&C, Time & Work, Percentage, Blood Relations, Syllogism, Coding-Decoding, Reading Comprehension, Grammar, OOPs basics, SQL basics, Data Structures',
        style: 'Moderate difficulty suitable for fresh graduates.',
        duration: 90, marksPerQuestion: 1, negativeMarking: 0.25,
    },
    'mba': {
        ...
        topics: 'Number Theory, Algebra, Geometry, Arithmetic, Data Interpretation, Logical Reasoning, Critical Reasoning, Para Jumbles, Reading Comprehension',
        style: 'High difficulty, time-pressured questions.',
        duration: 120, marksPerQuestion: 3, negativeMarking: 1,
    },
};
